      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-5 sm:px-8 space-y-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">Via Galileo Galilei 5, Pontecorvo (FR). Da San Giovanni Incarico si raggiunge in pochi minuti di auto. Parcheggio libero nelle immediate vicinanze. Lavoro esclusivamente su appuntamento — prenota online o chiamami al 320 963 1792.</p>
          </div>
        </div>
      </section>
