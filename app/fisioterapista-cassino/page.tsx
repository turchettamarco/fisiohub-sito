    ...
    <main className="bg-background text-foreground">
      <section className="py-20 sm:py-28 bg-card border-b border-border">
        <div className="mx-auto max-w-4xl px-5 sm:px-8">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            Via Galileo Galilei 5, Pontecorvo (FR) — 15 km da Cassino
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-5 sm:px-8 space-y-8">
          <div>
            <h2 className="font-display text-2xl sm:text-3xl font-semibold mb-4">Perché scegliere il mio studio vicino a Cassino</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              La qualità del trattamento non dipende dalla distanza dalla grande città. Dipende dalla competenza del professionista, dalla qualità della valutazione e dalla tecnologia disponibile. Nel mio studio a Pontecorvo — raggiungibile facilmente da Cassino — troverai sedute individuali dedicate, nessun paziente in contemporanea, il tempo necessario per ogni visita.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
      ...
      <section className="py-16 bg-primary/5 border-t border-primary/20">
        <div className="mx-auto max-w-2xl px-5 sm:px-8 text-center">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold mb-4">Fisioterapista vicino a Cassino — prenota ora</h2>
