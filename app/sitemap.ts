...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/fisioterapista-pignataro-interamna`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${base}/fisioterapista-esperia`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${base}/fisioterapista-pico`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${base}/fisioterapista-san-giovanni-incarico`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${base}/fisioterapista-monticelli`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    ...
    { url: `${base}/blog/laser-yag-come-funziona`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${base}/blog/prima-visita-fisioterapista`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
    { url: `${base}/blog/osteopatia-viscerale-intestino`, lastModified: new Date(), changeFrequency: 'monthly', priority: 0.75 },
  ]
}
