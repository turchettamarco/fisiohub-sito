      ...
      <section className="py-20 sm:py-28 bg-card border-b border-border">
        <div className="mx-auto max-w-4xl px-5 sm:px-8">
          ...
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            ...
            Via XXIV Maggio 6, Pontecorvo (FR) — 14 km da Esperia
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-5 sm:px-8 space-y-8">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed">Via XXIV Maggio 6, Pontecorvo (FR). Da Esperia si raggiunge in pochi minuti di auto. Parcheggio libero nelle immediate vicinanze. Lavoro esclusivamente su appuntamento — prenota online o chiamami al 320 963 1792.</p>
          </div>
        </div>
      </section>
