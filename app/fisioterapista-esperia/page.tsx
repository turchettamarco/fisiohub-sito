...
export const metadata: Metadata = {
  title: 'Fisioterapista Esperia | Marco Turchetta — Studio a Pontecorvo (FR)',
  description: 'Fisioterapista vicino a Esperia. Marco Turchetta, studio di fisioterapia e osteopatia a Pontecorvo (FR), 14 km da Esperia. Mal di schiena, cervicale, laser terapia, tecar, osteopatia. Prenota.',
  keywords: ['fisioterapista Esperia', 'fisioterapia Esperia', 'osteopata Esperia', 'fisioterapia vicino Esperia'],
  alternates: { canonical: 'https://turchettamarco.com/fisioterapista-esperia' },
}
    ...
    <main className="bg-background text-foreground">
      <section className="py-20 sm:py-28 bg-card border-b border-border">
        <div className="mx-auto max-w-4xl px-5 sm:px-8">
          <p className="text-sm font-semibold text-primary uppercase tracking-widest mb-4">Fisioterapista vicino a Esperia</p>
          <h1 className="font-display text-4xl sm:text-5xl font-semibold leading-tight mb-6">Fisioterapista a Esperia</h1>
          <p className="text-lg text-muted-foreground leading-relaxed mb-4 max-w-2xl">
            Cerchi un fisioterapista vicino a Esperia? Il mio studio di fisioterapia e osteopatia si trova a Pontecorvo (FR), a soli 14 km — raggiungibile facilmente, con parcheggio libero nelle vicinanze. Sedute individuali dedicate, nessuna lista d&apos;attesa lunga.
          </p>
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
            <MapPin className="h-4 w-4 text-primary" />
            Via Galileo Galilei 5, Pontecorvo (FR) — 14 km da Esperia
          </div>
      ...
      <section className="py-16 sm:py-20">
        <div className="mx-auto max-w-4xl px-5 sm:px-8 space-y-8">
          <div>
            <h2 className="font-display text-2xl sm:text-3xl font-semibold mb-4">Perché i pazienti di Esperia scelgono il mio studio</h2>
            <p className="text-muted-foreground leading-relaxed mb-4">
              Molti pazienti di Esperia si spostano più lontano per la fisioterapia pensando che la distanza significhi qualità. Non è necessariamente così — quello che conta è la competenza del professionista, la qualità della valutazione e la tecnologia disponibile.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-4">
              A soli 14 km da Esperia, il mio studio offre fisioterapia e osteopatia integrate in un unico percorso. Laurea in Fisioterapia (Sapienza di Roma), Master universitario in Osteopatia (EOM – Università di Verona), Diploma D.O. in completamento (Escuela Osteopática de Madrid). Tecnologia laser Nd:YAG Zaira e tecarterapia Globus Diacare 5000.
            </p>
          </div>
          ...
          <div>
            <h2 className="font-display text-2xl sm:text-3xl font-semibold mb-4">Come raggiungermi da Esperia</h2>
            <p className="text-muted-foreground leading-relaxed">Via Galileo Galilei 5, Pontecorvo (FR) — presso gli Studi Galileo. Da Esperia si raggiunge in pochi minuti di auto. Parcheggio libero nelle immediate vicinanze. Lavoro esclusivamente su appuntamento — prenota online o chiamami al 320 963 1792.</p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-primary/5 border-t border-primary/20">
        <div className="mx-auto max-w-2xl px-5 sm:px-8 text-center">
          <h2 className="font-display text-2xl sm:text-3xl font-semibold mb-4">Fisioterapista vicino a Esperia — prenota ora</h2>
